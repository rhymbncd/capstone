...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const HARDCODED_DOWNLOADS = {
        ...
        'Module 2: Polynomials': [
            ...
            { name: 'The Remainder Theorem and Factor Theorem',   file: 'The Remainder Theorem and Factor Theorem.pdf', size: '577 KB' },
    ...
    const FALLBACK_QUIZ_QUESTIONS = [
        ...
        { q: "Which of the following is a harmonic sequence?",                                                            choices: ["2, 4, 6, 8","1, 1/2, 1/3, 1/4","1, 2, 4, 8","1, 4, 9, 16"],                                              answer: 1 },
        { q: "What is the 3rd term of the harmonic sequence whose reciprocals form the arithmetic sequence 3, 7, 11, 15, ...?", choices: ["1/3","1/7","1/11","1/15"],                                                                          answer: 2 },
        { q: "What are the next two terms in the sequence 2, 3, 5, 8, 13, ...?",                                          choices: ["18, 24","21, 34","20, 33","19, 30"],                                                                      answer: 1 },
        { q: "In the Fibonacci sequence 1, 1, 2, 3, 5, 8, 13, ..., each term after the first two is obtained by:",        choices: ["Multiplying the two preceding terms","Adding the two preceding terms","Adding a constant difference","Multiplying by a common ratio"], answer: 1 },
        { q: "What is the sum of the finite arithmetic series 1 + 2 + 3 + ... + 20?",                                     choices: ["190","200","210","220"],                                                                                      answer: 2 },
        { q: "What is the sum to infinity of the geometric series 4 + 2 + 1 + 0.5 + ...?",                               choices: ["6","8","10","12"],                                                                                            answer: 1 },
        { q: "Divide: (x² + 5x + 6) ÷ (x + 2)",                                                                          choices: ["x + 3","x + 2","x − 3","x + 4"],                                                                              answer: 0 },
        { q: "Using synthetic division, what is the quotient when x³ − 6x² + 11x − 6 is divided by (x − 1)?",            choices: ["x² − 5x + 6","x² + 5x + 6","x² − 5x − 6","x² − 6x + 5"],                                                  answer: 0 },
        { q: "Using the Factor Theorem, which value of x is a root of P(x) = x³ − 3x² − x + 3?",                         choices: ["x = 1","x = 2","x = -2","x = 4"],                                                                             answer: 0 },
        { q: "What is the remainder when P(x) = 2x³ + x² − 5x + 3 is divided by (x + 1)?",                               choices: ["7","-7","3","-3"],                                                                                            answer: 0 },
        { q: "What are the roots of the equation x² − 5x + 6 = 0?",                                                      choices: ["x = 2, 3","x = -2, -3","x = 1, 6","x = -1, -6"],                                                          answer: 0 },
        { q: "What is the maximum number of real roots a cubic polynomial equation can have?",                          choices: ["1","2","3","4"],                                                                                              answer: 2 },
        { q: "What is the vertical asymptote of f(x) = (x + 1)/(x − 3)?",                                                choices: ["x = -1","x = 3","x = -3","x = 1"],                                                                            answer: 1 },
        { q: "What is the horizontal asymptote of f(x) = (2x + 1)/(x − 4)?",                                             choices: ["y = 2","y = 4","y = 1/2","y = -4"],                                                                           answer: 0 },
        { q: "Solve for x: √(x + 2) = 4",                                                                                choices: ["12","14","16","18"],                                                                                          answer: 1 },
        { q: "What is the domain restriction for f(x) = √(x − 5)?",                                                      choices: ["x ≥ 5","x ≤ 5","x > -5","x ≥ -5"],                                                                            answer: 0 },
        { q: "Which function represents exponential growth?",                                                            choices: ["y = 2(0.5)ˣ","y = 3(2)ˣ","y = 5 − x","y = x²"],                                                              answer: 1 },
        { q: "Solve for x: 3^(x+1) = 27",                                                                                choices: ["1","2","3","4"],                                                                                              answer: 1 },
        { q: "What is log₃(81)?",                                                                                        choices: ["3","4","5","6"],                                                                                              answer: 1 },
