    ...
    <div id="panel-calculator" class="chat-tabpanel" role="tabpanel" aria-labelledby="tab-calculator" tabindex="0" hidden>
        ...
        <div class="calc-pane">
            ...
            <div class="calc-keypad" id="calc-keypad">
                <button type="button" class="calc-key calc-key-fn" id="calc-angle-btn" data-action="angle" aria-pressed="true">deg</button>
                ...
                <button type="button" class="calc-key calc-key-fn calc-key-danger" data-action="backspace" aria-label="Backspace">del</button>
