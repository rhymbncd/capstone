            ...
            <div class="page" id="page-downloads">
                ...
                <section class="modules-container" id="section-mod2">
                    ...
                    <div class="download-item">
                        ...
                        <div class="download-info">
                            <span class="download-name">The Remainder Theorem and Factor Theorem.pdf</span>
                            <span class="download-meta">PDF · 577 KB</span>
                        </div>
                        <button class="dl-btn" data-action="download" data-file="The Remainder Theorem and Factor Theorem.pdf">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                        </button>
                    </div>
                    ...
                    <div class="download-item">
                        ...
                        <button class="dl-btn" data-action="download" data-file="Polynomial Equations.pdf">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                        </button>
                    </div>
                </section>
