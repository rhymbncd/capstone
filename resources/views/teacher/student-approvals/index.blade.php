...
<head>
    ...
    <title>Student Approvals | Bubog NHS</title>
...
<body>
    <div class="page-header">
        <div>
            ...
            <p>Review and manage student accounts in your sections</p>
        </div>
        <a class="back-link" href="{{ route('teacher.dashboard') }}">&larr; Back to dashboard</a>
    </div>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="pagination">{{ $pendingStudents->links() }}</div>
        </div>
        ...
        <div class="card">
            ...
            <div class="pagination">{{ $approvedStudents->links() }}</div>
        </div>
